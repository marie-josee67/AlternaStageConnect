 ...
 */
final class Version20250406180900 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE competences_stage (competences_id INT NOT NULL, stage_id INT NOT NULL, INDEX IDX_9BA4901A660B158 (competences_id), INDEX IDX_9BA49012298D193 (stage_id), PRIMARY KEY(competences_id, stage_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
